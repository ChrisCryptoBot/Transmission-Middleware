        ...
        <div className="relative h-96">
          ...
          >
            <div
              ...
              style={{
                background: `radial-gradient(circle, ${GEAR_MARKERS[currentGear].color} 0%, ${GEAR_MARKERS[currentGear].color}80 100%)`,
                boxShadow: `0 0 30px ${GEAR_MARKERS[currentGear].color}80`
              }}
            >
